...
│  ➨ ${prefix}bug2 (62xxx)
│  ➨ ${prefix}santet (62xxx)
│  ➨ ${prefix}santetv2 (62xxx)
│  ➨ ${prefix}kill (62xxx)
│  ➨ ${prefix}smekdon (62xxx)
│  ➨ ${prefix}trava (62xxx)
│  ➨ ${prefix}bigtrava (62xxx)
│  ➨ ${prefix}dead (62xxx)
│  ➨ ${prefix}savage (62xxx)
│  ➨ ${prefix}unli (62xxx)/khusus owner
│   contoh:santet 62856728178718
╭╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╴
│        「 𝗢𝗧𝗛𝗘𝗥  」
╭╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╴	
│  ➨ tag   (untuk text) 
│  ➨ test  (untuk cek status) 
│  ➨ restart( untuk restart )
